      ...
      <td class="text-center">
       ...
       <td class="text-center">
        ...
        <?php }?>
            ...
            <div class="btn-group-lg">   <button type="submit" class="btn btn-danger" style= ; margin-right: auto;" > <a href="../cart.php"  class="previous "method ="get" style= "color:white  " >Back </a></button>
                                </div>  
